...
/***/ "./src/algorithms/perfect-link.ts":
/*!****************************************!*\
  !*** ./src/algorithms/perfect-link.ts ***!
  \****************************************/
...
Object.defineProperty(exports, "__esModule", { value: true });
const model_1 = __webpack_require__(/*! ../models/model */ "./src/models/model.js");
class PerfectLink {
    constructor(system) {
        this.system = system;
    }
...
const network_listener_1 = __webpack_require__(/*! ./system/network-listener */ "./src/system/network-listener.ts");
...
/*!*****************************!*\
  !*** ./src/models/model.js ***!
  \*****************************/
/*! exports provided: ProcessId, UcPropose, EcStartEpoch, EpAbort, EpInit, EpAborted, EpPropose, EpDecide, UcDecide, EpRead_, EpState_, EpWrite_, EpAccept_, EpDecided_, EcNewEpoch_, EcNack_, BebBroadcast, BebDeliver, EldRecovery, EldTimeout, EldTrust, EldHeartbeat_, PlSend, PlDeliver, NetworkMessage, AppRegistration, AppPropose, AppDecide, Message, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProcessId", function() { return ProcessId; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UcPropose", function() { return UcPropose; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EcStartEpoch", function() { return EcStartEpoch; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EpAbort", function() { return EpAbort; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EpInit", function() { return EpInit; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EpAborted", function() { return EpAborted; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EpPropose", function() { return EpPropose; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EpDecide", function() { return EpDecide; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UcDecide", function() { return UcDecide; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EpRead_", function() { return EpRead_; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EpState_", function() { return EpState_; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EpWrite_", function() { return EpWrite_; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EpAccept_", function() { return EpAccept_; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EpDecided_", function() { return EpDecided_; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EcNewEpoch_", function() { return EcNewEpoch_; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EcNack_", function() { return EcNack_; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BebBroadcast", function() { return BebBroadcast; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BebDeliver", function() { return BebDeliver; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EldRecovery", function() { return EldRecovery; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EldTimeout", function() { return EldTimeout; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EldTrust", function() { return EldTrust; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EldHeartbeat_", function() { return EldHeartbeat_; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PlSend", function() { return PlSend; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PlDeliver", function() { return PlDeliver; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NetworkMessage", function() { return NetworkMessage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AppRegistration", function() { return AppRegistration; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AppPropose", function() { return AppPropose; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AppDecide", function() { return AppDecide; });
...
const $Reader = protobufjs_minimal__WEBPACK_IMPORTED_MODULE_0__["Reader"],
      $Writer = protobufjs_minimal__WEBPACK_IMPORTED_MODULE_0__["Writer"],
      $util = protobufjs_minimal__WEBPACK_IMPORTED_MODULE_0__["util"]; // Exported root namespace
...
const ProcessId = $root.ProcessId = (() => {
  /**
  ...
  ProcessId.encode = function encode(message, writer) {
    ...
    if (message.owner != null && Object.hasOwnProperty.call(message, "owner")) writer.uint32(
    /* id 3, wireType 2 =*/
    26).string(message.owner);
    if (message.index != null && Object.hasOwnProperty.call(message, "index")) writer.uint32(
    /* id 4, wireType 0 =*/
    32).int32(message.index);
    if (message.rank != null && Object.hasOwnProperty.call(message, "rank")) writer.uint32(
    /* id 5, wireType 0 =*/
    40).int32(message.rank);
    return writer;
  };
  /**
  ...
  ProcessId.verify = function verify(message) {
    ...
    if (message.rank != null && message.hasOwnProperty("rank")) if (!$util.isInteger(message.rank)) return "rank: integer expected";
    return null;
  };
  /**
  ...
  ProcessId.fromObject = function fromObject(object) {
    if (object instanceof $root.ProcessId) return object;
...
const UcPropose = $root.UcPropose = (() => {
  /**
  ...
  UcPropose.fromObject = function fromObject(object) {
    if (object instanceof $root.UcPropose) return object;
...
const EcStartEpoch = $root.EcStartEpoch = (() => {
  /**
  ...
  EcStartEpoch.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create();
    if (message.newTimestamp != null && Object.hasOwnProperty.call(message, "newTimestamp")) writer.uint32(
    /* id 1, wireType 0 =*/
    8).int32(message.newTimestamp);
    if (message.newLeader != null && Object.hasOwnProperty.call(message, "newLeader")) $root.ProcessId.encode(message.newLeader, writer.uint32(
    /* id 2, wireType 2 =*/
    18).fork()).ldelim();
    return writer;
  };
  ...
  EcStartEpoch.verify = function verify(message) {
    if (typeof message !== "object" || message === null) return "object expected";
    if (message.newTimestamp != null && message.hasOwnProperty("newTimestamp")) if (!$util.isInteger(message.newTimestamp)) return "newTimestamp: integer expected";

    if (message.newLeader != null && message.hasOwnProperty("newLeader")) {
      let error = $root.ProcessId.verify(message.newLeader);
      if (error) return "newLeader." + error;
    }
  ...
  EcStartEpoch.fromObject = function fromObject(object) {
    if (object instanceof $root.EcStartEpoch) return object;
    let message = new $root.EcStartEpoch();
    if (object.newTimestamp != null) message.newTimestamp = object.newTimestamp | 0;

    if (object.newLeader != null) {
      if (typeof object.newLeader !== "object") throw TypeError(".EcStartEpoch.newLeader: object expected");
  ...
  EcStartEpoch.toObject = function toObject(message, options) {
    ...
    if (message.newTimestamp != null && message.hasOwnProperty("newTimestamp")) object.newTimestamp = message.newTimestamp;
    if (message.newLeader != null && message.hasOwnProperty("newLeader")) object.newLeader = $root.ProcessId.toObject(message.newLeader, options);
    return object;
  };
  /**
...
const EpAbort = $root.EpAbort = (() => {
  ...
  EpAbort.fromObject = function fromObject(object) {
    if (object instanceof $root.EpAbort) return object;
...
const EpInit = $root.EpInit = (() => {
  ...
  EpInit.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create();
    if (message.valueTimestamp != null && Object.hasOwnProperty.call(message, "valueTimestamp")) writer.uint32(
    /* id 1, wireType 0 =*/
    8).int32(message.valueTimestamp);
    if (message.value != null && Object.hasOwnProperty.call(message, "value")) writer.uint32(
    /* id 2, wireType 0 =*/
    16).int32(message.value);
    return writer;
  };
  /**
  ...
  EpInit.verify = function verify(message) {
    if (typeof message !== "object" || message === null) return "object expected";
    if (message.valueTimestamp != null && message.hasOwnProperty("valueTimestamp")) if (!$util.isInteger(message.valueTimestamp)) return "valueTimestamp: integer expected";
    if (message.value != null && message.hasOwnProperty("value")) if (!$util.isInteger(message.value)) return "value: integer expected";
    return null;
  };
  /**
  ...
  EpInit.fromObject = function fromObject(object) {
    if (object instanceof $root.EpInit) return object;
    let message = new $root.EpInit();
    if (object.valueTimestamp != null) message.valueTimestamp = object.valueTimestamp | 0;
    if (object.value != null) message.value = object.value | 0;
    return message;
  };
  /**
  ...
  EpInit.toObject = function toObject(message, options) {
    ...
    if (message.valueTimestamp != null && message.hasOwnProperty("valueTimestamp")) object.valueTimestamp = message.valueTimestamp;
    if (message.value != null && message.hasOwnProperty("value")) object.value = message.value;
    return object;
  };
  /**
...
const EpAborted = $root.EpAborted = (() => {
  /**
  ...
  EpAborted.fromObject = function fromObject(object) {
    if (object instanceof $root.EpAborted) return object;
...
const EpPropose = $root.EpPropose = (() => {
  /**
  ...
  EpPropose.fromObject = function fromObject(object) {
    if (object instanceof $root.EpPropose) return object;
...
const EpDecide = $root.EpDecide = (() => {
  ...
  EpDecide.fromObject = function fromObject(object) {
    if (object instanceof $root.EpDecide) return object;
...
const UcDecide = $root.UcDecide = (() => {
  ...
  UcDecide.fromObject = function fromObject(object) {
    if (object instanceof $root.UcDecide) return object;
...
const EpRead_ = $root.EpRead_ = (() => {
  ...
  EpRead_.fromObject = function fromObject(object) {
    if (object instanceof $root.EpRead_) return object;
...
const EpState_ = $root.EpState_ = (() => {
  ...
  EpState_.fromObject = function fromObject(object) {
    if (object instanceof $root.EpState_) return object;
...
const EpWrite_ = $root.EpWrite_ = (() => {
  ...
  EpWrite_.fromObject = function fromObject(object) {
    if (object instanceof $root.EpWrite_) return object;
...
const EpAccept_ = $root.EpAccept_ = (() => {
  /**
  ...
  EpAccept_.fromObject = function fromObject(object) {
    if (object instanceof $root.EpAccept_) return object;
...
const EpDecided_ = $root.EpDecided_ = (() => {
  /**
  ...
  EpDecided_.fromObject = function fromObject(object) {
    if (object instanceof $root.EpDecided_) return object;
...
const EcNewEpoch_ = $root.EcNewEpoch_ = (() => {
  /**
  ...
  EcNewEpoch_.fromObject = function fromObject(object) {
    if (object instanceof $root.EcNewEpoch_) return object;
...
const EcNack_ = $root.EcNack_ = (() => {
  ...
  EcNack_.fromObject = function fromObject(object) {
    if (object instanceof $root.EcNack_) return object;
...
const BebBroadcast = $root.BebBroadcast = (() => {
  /**
  ...
  BebBroadcast.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create();
    if (message.message != null && Object.hasOwnProperty.call(message, "message")) $root.Message.encode(message.message, writer.uint32(
    /* id 1, wireType 2 =*/
    10).fork()).ldelim();
    return writer;
  };
  ...
  BebBroadcast.fromObject = function fromObject(object) {
    if (object instanceof $root.BebBroadcast) return object;
    let message = new $root.BebBroadcast();

    if (object.message != null) {
      if (typeof object.message !== "object") throw TypeError(".BebBroadcast.message: object expected");
  ...
  BebBroadcast.toObject = function toObject(message, options) {
    ...
    if (message.message != null && message.hasOwnProperty("message")) object.message = $root.Message.toObject(message.message, options);
    return object;
  };
  /**
...
const BebDeliver = $root.BebDeliver = (() => {
  /**
  ...
  BebDeliver.encode = function encode(message, writer) {
    ...
    /* id 1, wireType 2 =*/
    10).fork()).ldelim();
    if (message.sender != null && Object.hasOwnProperty.call(message, "sender")) $root.ProcessId.encode(message.sender, writer.uint32(
    /* id 2, wireType 2 =*/
    18).fork()).ldelim();
    return writer;
  };
  ...
  BebDeliver.fromObject = function fromObject(object) {
    if (object instanceof $root.BebDeliver) return object;
    let message = new $root.BebDeliver();

    if (object.message != null) {
      if (typeof object.message !== "object") throw TypeError(".BebDeliver.message: object expected");
      message.message = $root.Message.fromObject(object.message);
    }

    if (object.sender != null) {
      if (typeof object.sender !== "object") throw TypeError(".BebDeliver.sender: object expected");
  ...
  BebDeliver.toObject = function toObject(message, options) {
    ...
    if (message.message != null && message.hasOwnProperty("message")) object.message = $root.Message.toObject(message.message, options);
    if (message.sender != null && message.hasOwnProperty("sender")) object.sender = $root.ProcessId.toObject(message.sender, options);
    return object;
  };
  /**
...
const EldRecovery = $root.EldRecovery = (() => {
  /**
  ...
  EldRecovery.fromObject = function fromObject(object) {
    if (object instanceof $root.EldRecovery) return object;
...
const EldTimeout = $root.EldTimeout = (() => {
  /**
  ...
  EldTimeout.fromObject = function fromObject(object) {
    if (object instanceof $root.EldTimeout) return object;
...
const EldTrust = $root.EldTrust = (() => {
  ...
  EldTrust.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create();
    if (message.processId != null && Object.hasOwnProperty.call(message, "processId")) $root.ProcessId.encode(message.processId, writer.uint32(
    /* id 1, wireType 2 =*/
    10).fork()).ldelim();
    return writer;
  };
  ...
  EldTrust.verify = function verify(message) {
    ...
    if (message.processId != null && message.hasOwnProperty("processId")) {
      ...
      if (error) return "processId." + error;
    }
  ...
  EldTrust.fromObject = function fromObject(object) {
    if (object instanceof $root.EldTrust) return object;
    let message = new $root.EldTrust();

    if (object.processId != null) {
      if (typeof object.processId !== "object") throw TypeError(".EldTrust.processId: object expected");
  ...
  EldTrust.toObject = function toObject(message, options) {
    if (!options) options = {};
    let object = {};
    if (options.defaults) object.processId = null;
    if (message.processId != null && message.hasOwnProperty("processId")) object.processId = $root.ProcessId.toObject(message.processId, options);
    return object;
  };
  /**
...
const EldHeartbeat_ = $root.EldHeartbeat_ = (() => {
  /**
  ...
  EldHeartbeat_.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create();
    if (message.epoch != null && Object.hasOwnProperty.call(message, "epoch")) writer.uint32(
    /* id 1, wireType 0 =*/
    8).int32(message.epoch);
    return writer;
  };
  /**
  ...
  EldHeartbeat_.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.EldHeartbeat_();
  ...
  EldHeartbeat_.verify = function verify(message) {
    if (typeof message !== "object" || message === null) return "object expected";
    if (message.epoch != null && message.hasOwnProperty("epoch")) if (!$util.isInteger(message.epoch)) return "epoch: integer expected";
    return null;
  };
  /**
  ...
  EldHeartbeat_.fromObject = function fromObject(object) {
    if (object instanceof $root.EldHeartbeat_) return object;
    let message = new $root.EldHeartbeat_();
    if (object.epoch != null) message.epoch = object.epoch | 0;
    return message;
  };
  /**
  ...
  EldHeartbeat_.toObject = function toObject(message, options) {
    if (!options) options = {};
    let object = {};
    if (options.defaults) object.epoch = 0;
    if (message.epoch != null && message.hasOwnProperty("epoch")) object.epoch = message.epoch;
    return object;
  };
  /**
...
const PlSend = $root.PlSend = (() => {
  ...
  PlSend.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create();
    if (message.destination != null && Object.hasOwnProperty.call(message, "destination")) $root.ProcessId.encode(message.destination, writer.uint32(
    /* id 1, wireType 2 =*/
    10).fork()).ldelim();
    if (message.message != null && Object.hasOwnProperty.call(message, "message")) $root.Message.encode(message.message, writer.uint32(
    /* id 2, wireType 2 =*/
  ...
  PlSend.verify = function verify(message) {
    ...
    if (message.destination != null && message.hasOwnProperty("destination")) {
      ...
      if (error) return "destination." + error;
    }
  ...
  PlSend.fromObject = function fromObject(object) {
    if (object instanceof $root.PlSend) return object;
    let message = new $root.PlSend();

    if (object.destination != null) {
      if (typeof object.destination !== "object") throw TypeError(".PlSend.destination: object expected");
      message.destination = $root.ProcessId.fromObject(object.destination);
    }

    if (object.message != null) {
      if (typeof object.message !== "object") throw TypeError(".PlSend.message: object expected");
      message.message = $root.Message.fromObject(object.message);
    }
  ...
  PlSend.toObject = function toObject(message, options) {
    ...
    if (message.destination != null && message.hasOwnProperty("destination")) object.destination = $root.ProcessId.toObject(message.destination, options);
    if (message.message != null && message.hasOwnProperty("message")) object.message = $root.Message.toObject(message.message, options);
    return object;
  };
  /**
...
const PlDeliver = $root.PlDeliver = (() => {
  /**
  ...
  PlDeliver.fromObject = function fromObject(object) {
    if (object instanceof $root.PlDeliver) return object;
    let message = new $root.PlDeliver();

    if (object.sender != null) {
      if (typeof object.sender !== "object") throw TypeError(".PlDeliver.sender: object expected");
      message.sender = $root.ProcessId.fromObject(object.sender);
    }

    if (object.message != null) {
      if (typeof object.message !== "object") throw TypeError(".PlDeliver.message: object expected");
      message.message = $root.Message.fromObject(object.message);
    }
...
const NetworkMessage = $root.NetworkMessage = (() => {
  /**
  ...
  NetworkMessage.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create();
    if (message.rendezvousPort != null && Object.hasOwnProperty.call(message, "rendezvousPort")) writer.uint32(
    /* id 1, wireType 0 =*/
    8).int32(message.rendezvousPort);
    if (message.message != null && Object.hasOwnProperty.call(message, "message")) $root.Message.encode(message.message, writer.uint32(
    /* id 2, wireType 2 =*/
    18).fork()).ldelim();
    return writer;
  ...
  NetworkMessage.verify = function verify(message) {
    if (typeof message !== "object" || message === null) return "object expected";
    if (message.rendezvousPort != null && message.hasOwnProperty("rendezvousPort")) if (!$util.isInteger(message.rendezvousPort)) return "rendezvousPort: integer expected";
  ...
  NetworkMessage.fromObject = function fromObject(object) {
    if (object instanceof $root.NetworkMessage) return object;
    let message = new $root.NetworkMessage();
    if (object.rendezvousPort != null) message.rendezvousPort = object.rendezvousPort | 0;

    if (object.message != null) {
      if (typeof object.message !== "object") throw TypeError(".NetworkMessage.message: object expected");
      message.message = $root.Message.fromObject(object.message);
    }
  ...
  NetworkMessage.toObject = function toObject(message, options) {
    ...
    if (message.rendezvousPort != null && message.hasOwnProperty("rendezvousPort")) object.rendezvousPort = message.rendezvousPort;
    if (message.message != null && message.hasOwnProperty("message")) object.message = $root.Message.toObject(message.message, options);
    return object;
  };
  /**
...
const AppRegistration = $root.AppRegistration = (() => {
  /**
  ...
  AppRegistration.encode = function encode(message, writer) {
    ...
    if (message.owner != null && Object.hasOwnProperty.call(message, "owner")) writer.uint32(
    /* id 1, wireType 2 =*/
    10).string(message.owner);
    if (message.index != null && Object.hasOwnProperty.call(message, "index")) writer.uint32(
    /* id 2, wireType 0 =*/
    16).int32(message.index);
    if (message.port != null && Object.hasOwnProperty.call(message, "port")) writer.uint32(
    /* id 3, wireType 0 =*/
    24).int32(message.port);
    return writer;
  };
  /**
  ...
  AppRegistration.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.AppRegistration();
  ...
  AppRegistration.fromObject = function fromObject(object) {
    if (object instanceof $root.AppRegistration) return object;
...
const AppPropose = $root.AppPropose = (() => {
  /**
  ...
  AppPropose.encode = function encode(message, writer) {
    ...
    /* id 1, wireType 0 =*/
    8).int32(message.value);
    if (message.systemId != null && Object.hasOwnProperty.call(message, "systemId")) writer.uint32(
    /* id 2, wireType 2 =*/
    18).string(message.systemId);
    if (message.processes != null && message.processes.length) for (let i = 0; i < message.processes.length; ++i) $root.ProcessId.encode(message.processes[i], writer.uint32(
    /* id 3, wireType 2 =*/
    26).fork()).ldelim();
    return writer;
  };
  ...
  AppPropose.decode = function decode(reader, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          if (!(message.processes && message.processes.length)) message.processes = [];
  ...
  AppPropose.verify = function verify(message) {
    if (typeof message !== "object" || message === null) return "object expected";
    if (message.value != null && message.hasOwnProperty("value")) if (!$util.isInteger(message.value)) return "value: integer expected";
    if (message.systemId != null && message.hasOwnProperty("systemId")) if (!$util.isString(message.systemId)) return "systemId: string expected";

    if (message.processes != null && message.hasOwnProperty("processes")) {
      if (!Array.isArray(message.processes)) return "processes: array expected";

      for (let i = 0; i < message.processes.length; ++i) {
        let error = $root.ProcessId.verify(message.processes[i]);
        if (error) return "processes." + error;
      }
    }
  ...
  AppPropose.fromObject = function fromObject(object) {
    if (object instanceof $root.AppPropose) return object;
    let message = new $root.AppPropose();
    if (object.value != null) message.value = object.value | 0;
    if (object.systemId != null) message.systemId = String(object.systemId);

    if (object.processes) {
      if (!Array.isArray(object.processes)) throw TypeError(".AppPropose.processes: array expected");
      message.processes = [];

      for (let i = 0; i < object.processes.length; ++i) {
        if (typeof object.processes[i] !== "object") throw TypeError(".AppPropose.processes: object expected");
  ...
  AppPropose.toObject = function toObject(message, options) {
    if (!options) options = {};
    let object = {};
    if (options.arrays || options.defaults) object.processes = [];
    ...
    if (message.processes && message.processes.length) {
      ...
      for (let j = 0; j < message.processes.length; ++j) object.processes[j] = $root.ProcessId.toObject(message.processes[j], options);
    }
...
const AppDecide = $root.AppDecide = (() => {
  /**
  ...
  AppDecide.fromObject = function fromObject(object) {
    if (object instanceof $root.AppDecide) return object;
...
const Message = $root.Message = (() => {
  ...
  Message.encode = function encode(message, writer) {
    ...
    if (message.messageUuid != null && Object.hasOwnProperty.call(message, "messageUuid")) writer.uint32(
    /* id 2, wireType 2 =*/
    18).string(message.messageUuid);
    if (message.abstractionId != null && Object.hasOwnProperty.call(message, "abstractionId")) writer.uint32(
    /* id 3, wireType 2 =*/
    26).string(message.abstractionId);
    if (message.systemId != null && Object.hasOwnProperty.call(message, "systemId")) writer.uint32(
    /* id 4, wireType 2 =*/
    34).string(message.systemId);
    if (message.appRegistration != null && Object.hasOwnProperty.call(message, "appRegistration")) $root.AppRegistration.encode(message.appRegistration, writer.uint32(
    /* id 5, wireType 2 =*/
    42).fork()).ldelim();
    if (message.appPropose != null && Object.hasOwnProperty.call(message, "appPropose")) $root.AppPropose.encode(message.appPropose, writer.uint32(
    /* id 6, wireType 2 =*/
    50).fork()).ldelim();
    if (message.appDecide != null && Object.hasOwnProperty.call(message, "appDecide")) $root.AppDecide.encode(message.appDecide, writer.uint32(
    /* id 7, wireType 2 =*/
    58).fork()).ldelim();
    if (message.bebBroadcast != null && Object.hasOwnProperty.call(message, "bebBroadcast")) $root.BebBroadcast.encode(message.bebBroadcast, writer.uint32(
    /* id 10, wireType 2 =*/
    82).fork()).ldelim();
    if (message.bebDeliver != null && Object.hasOwnProperty.call(message, "bebDeliver")) $root.BebDeliver.encode(message.bebDeliver, writer.uint32(
    /* id 11, wireType 2 =*/
    90).fork()).ldelim();
    if (message.ecNack_ != null && Object.hasOwnProperty.call(message, "ecNack_")) $root.EcNack_.encode(message.ecNack_, writer.uint32(
    /* id 12, wireType 2 =*/
    98).fork()).ldelim();
    if (message.ecNewEpoch_ != null && Object.hasOwnProperty.call(message, "ecNewEpoch_")) $root.EcNewEpoch_.encode(message.ecNewEpoch_, writer.uint32(
    /* id 13, wireType 2 =*/
    106).fork()).ldelim();
    if (message.ecStartEpoch != null && Object.hasOwnProperty.call(message, "ecStartEpoch")) $root.EcStartEpoch.encode(message.ecStartEpoch, writer.uint32(
    /* id 14, wireType 2 =*/
    114).fork()).ldelim();
    if (message.eldHeartbeat_ != null && Object.hasOwnProperty.call(message, "eldHeartbeat_")) $root.EldHeartbeat_.encode(message.eldHeartbeat_, writer.uint32(
    /* id 15, wireType 2 =*/
    122).fork()).ldelim();
    if (message.eldRecovery != null && Object.hasOwnProperty.call(message, "eldRecovery")) $root.EldRecovery.encode(message.eldRecovery, writer.uint32(
    /* id 16, wireType 2 =*/
    130).fork()).ldelim();
    if (message.eldTimeout != null && Object.hasOwnProperty.call(message, "eldTimeout")) $root.EldTimeout.encode(message.eldTimeout, writer.uint32(
    /* id 17, wireType 2 =*/
    138).fork()).ldelim();
    if (message.eldTrust != null && Object.hasOwnProperty.call(message, "eldTrust")) $root.EldTrust.encode(message.eldTrust, writer.uint32(
    /* id 18, wireType 2 =*/
    146).fork()).ldelim();
    if (message.epAbort != null && Object.hasOwnProperty.call(message, "epAbort")) $root.EpAbort.encode(message.epAbort, writer.uint32(
    /* id 19, wireType 2 =*/
    154).fork()).ldelim();
    if (message.epAborted != null && Object.hasOwnProperty.call(message, "epAborted")) $root.EpAborted.encode(message.epAborted, writer.uint32(
    /* id 20, wireType 2 =*/
    162).fork()).ldelim();
    if (message.epAccept_ != null && Object.hasOwnProperty.call(message, "epAccept_")) $root.EpAccept_.encode(message.epAccept_, writer.uint32(
    /* id 21, wireType 2 =*/
    170).fork()).ldelim();
    if (message.epDecide != null && Object.hasOwnProperty.call(message, "epDecide")) $root.EpDecide.encode(message.epDecide, writer.uint32(
    /* id 22, wireType 2 =*/
    178).fork()).ldelim();
    if (message.epDecided_ != null && Object.hasOwnProperty.call(message, "epDecided_")) $root.EpDecided_.encode(message.epDecided_, writer.uint32(
    /* id 23, wireType 2 =*/
    186).fork()).ldelim();
    if (message.epInit != null && Object.hasOwnProperty.call(message, "epInit")) $root.EpInit.encode(message.epInit, writer.uint32(
    /* id 24, wireType 2 =*/
    194).fork()).ldelim();
    if (message.epPropose != null && Object.hasOwnProperty.call(message, "epPropose")) $root.EpPropose.encode(message.epPropose, writer.uint32(
    /* id 25, wireType 2 =*/
    202).fork()).ldelim();
    if (message.epRead_ != null && Object.hasOwnProperty.call(message, "epRead_")) $root.EpRead_.encode(message.epRead_, writer.uint32(
    /* id 26, wireType 2 =*/
    210).fork()).ldelim();
    if (message.epState_ != null && Object.hasOwnProperty.call(message, "epState_")) $root.EpState_.encode(message.epState_, writer.uint32(
    /* id 27, wireType 2 =*/
    218).fork()).ldelim();
    if (message.epWrite_ != null && Object.hasOwnProperty.call(message, "epWrite_")) $root.EpWrite_.encode(message.epWrite_, writer.uint32(
    /* id 28, wireType 2 =*/
    226).fork()).ldelim();
    if (message.plDeliver != null && Object.hasOwnProperty.call(message, "plDeliver")) $root.PlDeliver.encode(message.plDeliver, writer.uint32(
    /* id 29, wireType 2 =*/
    234).fork()).ldelim();
    if (message.plSend != null && Object.hasOwnProperty.call(message, "plSend")) $root.PlSend.encode(message.plSend, writer.uint32(
    /* id 30, wireType 2 =*/
    242).fork()).ldelim();
    if (message.ucDecide != null && Object.hasOwnProperty.call(message, "ucDecide")) $root.UcDecide.encode(message.ucDecide, writer.uint32(
    /* id 31, wireType 2 =*/
    250).fork()).ldelim();
    if (message.ucPropose != null && Object.hasOwnProperty.call(message, "ucPropose")) $root.UcPropose.encode(message.ucPropose, writer.uint32(
    /* id 32, wireType 2 =*/
    258).fork()).ldelim();
    return writer;
  };
  ...
  Message.verify = function verify(message) {
    ...
    if (message.messageUuid != null && message.hasOwnProperty("messageUuid")) if (!$util.isString(message.messageUuid)) return "messageUuid: string expected";
    if (message.abstractionId != null && message.hasOwnProperty("abstractionId")) if (!$util.isString(message.abstractionId)) return "abstractionId: string expected";
    if (message.systemId != null && message.hasOwnProperty("systemId")) if (!$util.isString(message.systemId)) return "systemId: string expected";
  ...
  Message.fromObject = function fromObject(object) {
    ...
    if (object.messageUuid != null) message.messageUuid = String(object.messageUuid);
    if (object.abstractionId != null) message.abstractionId = String(object.abstractionId);
    if (object.systemId != null) message.systemId = String(object.systemId);

    if (object.appRegistration != null) {
      if (typeof object.appRegistration !== "object") throw TypeError(".Message.appRegistration: object expected");
      message.appRegistration = $root.AppRegistration.fromObject(object.appRegistration);
    }

    if (object.appPropose != null) {
      if (typeof object.appPropose !== "object") throw TypeError(".Message.appPropose: object expected");
      message.appPropose = $root.AppPropose.fromObject(object.appPropose);
    }

    if (object.appDecide != null) {
      if (typeof object.appDecide !== "object") throw TypeError(".Message.appDecide: object expected");
      message.appDecide = $root.AppDecide.fromObject(object.appDecide);
    }

    if (object.bebBroadcast != null) {
      if (typeof object.bebBroadcast !== "object") throw TypeError(".Message.bebBroadcast: object expected");
      message.bebBroadcast = $root.BebBroadcast.fromObject(object.bebBroadcast);
    }

    if (object.bebDeliver != null) {
      if (typeof object.bebDeliver !== "object") throw TypeError(".Message.bebDeliver: object expected");
      message.bebDeliver = $root.BebDeliver.fromObject(object.bebDeliver);
    }

    if (object.ecNack_ != null) {
      if (typeof object.ecNack_ !== "object") throw TypeError(".Message.ecNack_: object expected");
      message.ecNack_ = $root.EcNack_.fromObject(object.ecNack_);
    }

    if (object.ecNewEpoch_ != null) {
      if (typeof object.ecNewEpoch_ !== "object") throw TypeError(".Message.ecNewEpoch_: object expected");
      message.ecNewEpoch_ = $root.EcNewEpoch_.fromObject(object.ecNewEpoch_);
    }

    if (object.ecStartEpoch != null) {
      if (typeof object.ecStartEpoch !== "object") throw TypeError(".Message.ecStartEpoch: object expected");
      message.ecStartEpoch = $root.EcStartEpoch.fromObject(object.ecStartEpoch);
    }

    if (object.eldHeartbeat_ != null) {
      if (typeof object.eldHeartbeat_ !== "object") throw TypeError(".Message.eldHeartbeat_: object expected");
      message.eldHeartbeat_ = $root.EldHeartbeat_.fromObject(object.eldHeartbeat_);
    }

    if (object.eldRecovery != null) {
      if (typeof object.eldRecovery !== "object") throw TypeError(".Message.eldRecovery: object expected");
      message.eldRecovery = $root.EldRecovery.fromObject(object.eldRecovery);
    }

    if (object.eldTimeout != null) {
      if (typeof object.eldTimeout !== "object") throw TypeError(".Message.eldTimeout: object expected");
      message.eldTimeout = $root.EldTimeout.fromObject(object.eldTimeout);
    }

    if (object.eldTrust != null) {
      if (typeof object.eldTrust !== "object") throw TypeError(".Message.eldTrust: object expected");
      message.eldTrust = $root.EldTrust.fromObject(object.eldTrust);
    }

    if (object.epAbort != null) {
      if (typeof object.epAbort !== "object") throw TypeError(".Message.epAbort: object expected");
      message.epAbort = $root.EpAbort.fromObject(object.epAbort);
    }

    if (object.epAborted != null) {
      if (typeof object.epAborted !== "object") throw TypeError(".Message.epAborted: object expected");
      message.epAborted = $root.EpAborted.fromObject(object.epAborted);
    }

    if (object.epAccept_ != null) {
      if (typeof object.epAccept_ !== "object") throw TypeError(".Message.epAccept_: object expected");
      message.epAccept_ = $root.EpAccept_.fromObject(object.epAccept_);
    }

    if (object.epDecide != null) {
      if (typeof object.epDecide !== "object") throw TypeError(".Message.epDecide: object expected");
      message.epDecide = $root.EpDecide.fromObject(object.epDecide);
    }

    if (object.epDecided_ != null) {
      if (typeof object.epDecided_ !== "object") throw TypeError(".Message.epDecided_: object expected");
      message.epDecided_ = $root.EpDecided_.fromObject(object.epDecided_);
    }

    if (object.epInit != null) {
      if (typeof object.epInit !== "object") throw TypeError(".Message.epInit: object expected");
      message.epInit = $root.EpInit.fromObject(object.epInit);
    }

    if (object.epPropose != null) {
      if (typeof object.epPropose !== "object") throw TypeError(".Message.epPropose: object expected");
      message.epPropose = $root.EpPropose.fromObject(object.epPropose);
    }

    if (object.epRead_ != null) {
      if (typeof object.epRead_ !== "object") throw TypeError(".Message.epRead_: object expected");
      message.epRead_ = $root.EpRead_.fromObject(object.epRead_);
    }

    if (object.epState_ != null) {
      if (typeof object.epState_ !== "object") throw TypeError(".Message.epState_: object expected");
      message.epState_ = $root.EpState_.fromObject(object.epState_);
    }

    if (object.epWrite_ != null) {
      if (typeof object.epWrite_ !== "object") throw TypeError(".Message.epWrite_: object expected");
      message.epWrite_ = $root.EpWrite_.fromObject(object.epWrite_);
    }

    if (object.plDeliver != null) {
      if (typeof object.plDeliver !== "object") throw TypeError(".Message.plDeliver: object expected");
      message.plDeliver = $root.PlDeliver.fromObject(object.plDeliver);
    }

    if (object.plSend != null) {
      if (typeof object.plSend !== "object") throw TypeError(".Message.plSend: object expected");
      message.plSend = $root.PlSend.fromObject(object.plSend);
    }

    if (object.ucDecide != null) {
      if (typeof object.ucDecide !== "object") throw TypeError(".Message.ucDecide: object expected");
      message.ucDecide = $root.UcDecide.fromObject(object.ucDecide);
    }

    if (object.ucPropose != null) {
      if (typeof object.ucPropose !== "object") throw TypeError(".Message.ucPropose: object expected");
  ...
  Message.toObject = function toObject(message, options) {
    ...
    if (message.type != null && message.hasOwnProperty("type")) object.type = options.enums === String ? $root.Message.Type[message.type] : message.type;
    if (message.messageUuid != null && message.hasOwnProperty("messageUuid")) object.messageUuid = message.messageUuid;
    if (message.abstractionId != null && message.hasOwnProperty("abstractionId")) object.abstractionId = message.abstractionId;
    if (message.systemId != null && message.hasOwnProperty("systemId")) object.systemId = message.systemId;
    if (message.appRegistration != null && message.hasOwnProperty("appRegistration")) object.appRegistration = $root.AppRegistration.toObject(message.appRegistration, options);
    if (message.appPropose != null && message.hasOwnProperty("appPropose")) object.appPropose = $root.AppPropose.toObject(message.appPropose, options);
    if (message.appDecide != null && message.hasOwnProperty("appDecide")) object.appDecide = $root.AppDecide.toObject(message.appDecide, options);
    if (message.bebBroadcast != null && message.hasOwnProperty("bebBroadcast")) object.bebBroadcast = $root.BebBroadcast.toObject(message.bebBroadcast, options);
    if (message.bebDeliver != null && message.hasOwnProperty("bebDeliver")) object.bebDeliver = $root.BebDeliver.toObject(message.bebDeliver, options);
    if (message.ecNack_ != null && message.hasOwnProperty("ecNack_")) object.ecNack_ = $root.EcNack_.toObject(message.ecNack_, options);
    if (message.ecNewEpoch_ != null && message.hasOwnProperty("ecNewEpoch_")) object.ecNewEpoch_ = $root.EcNewEpoch_.toObject(message.ecNewEpoch_, options);
    if (message.ecStartEpoch != null && message.hasOwnProperty("ecStartEpoch")) object.ecStartEpoch = $root.EcStartEpoch.toObject(message.ecStartEpoch, options);
    if (message.eldHeartbeat_ != null && message.hasOwnProperty("eldHeartbeat_")) object.eldHeartbeat_ = $root.EldHeartbeat_.toObject(message.eldHeartbeat_, options);
    if (message.eldRecovery != null && message.hasOwnProperty("eldRecovery")) object.eldRecovery = $root.EldRecovery.toObject(message.eldRecovery, options);
    if (message.eldTimeout != null && message.hasOwnProperty("eldTimeout")) object.eldTimeout = $root.EldTimeout.toObject(message.eldTimeout, options);
    if (message.eldTrust != null && message.hasOwnProperty("eldTrust")) object.eldTrust = $root.EldTrust.toObject(message.eldTrust, options);
    if (message.epAbort != null && message.hasOwnProperty("epAbort")) object.epAbort = $root.EpAbort.toObject(message.epAbort, options);
    if (message.epAborted != null && message.hasOwnProperty("epAborted")) object.epAborted = $root.EpAborted.toObject(message.epAborted, options);
    if (message.epAccept_ != null && message.hasOwnProperty("epAccept_")) object.epAccept_ = $root.EpAccept_.toObject(message.epAccept_, options);
    if (message.epDecide != null && message.hasOwnProperty("epDecide")) object.epDecide = $root.EpDecide.toObject(message.epDecide, options);
    if (message.epDecided_ != null && message.hasOwnProperty("epDecided_")) object.epDecided_ = $root.EpDecided_.toObject(message.epDecided_, options);
    if (message.epInit != null && message.hasOwnProperty("epInit")) object.epInit = $root.EpInit.toObject(message.epInit, options);
    if (message.epPropose != null && message.hasOwnProperty("epPropose")) object.epPropose = $root.EpPropose.toObject(message.epPropose, options);
    if (message.epRead_ != null && message.hasOwnProperty("epRead_")) object.epRead_ = $root.EpRead_.toObject(message.epRead_, options);
    if (message.epState_ != null && message.hasOwnProperty("epState_")) object.epState_ = $root.EpState_.toObject(message.epState_, options);
    if (message.epWrite_ != null && message.hasOwnProperty("epWrite_")) object.epWrite_ = $root.EpWrite_.toObject(message.epWrite_, options);
    if (message.plDeliver != null && message.hasOwnProperty("plDeliver")) object.plDeliver = $root.PlDeliver.toObject(message.plDeliver, options);
    if (message.plSend != null && message.hasOwnProperty("plSend")) object.plSend = $root.PlSend.toObject(message.plSend, options);
    if (message.ucDecide != null && message.hasOwnProperty("ucDecide")) object.ucDecide = $root.UcDecide.toObject(message.ucDecide, options);
    if (message.ucPropose != null && message.hasOwnProperty("ucPropose")) object.ucPropose = $root.UcPropose.toObject(message.ucPropose, options);
    return object;
  };
  /**
...
/***/ "./src/system/network-listener.ts":
/*!****************************************!*\
  !*** ./src/system/network-listener.ts ***!
  \****************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const perfect_link_1 = __webpack_require__(/*! ../algorithms/perfect-link */ "./src/algorithms/perfect-link.ts");
class System {
    constructor() {
        this.processes = [];
        this.algorithms = [];
